class Hparams:
    # construct_sg
    opus_en = "opensubtitles2018/OpenSubtitles.en-es.en1.txt"
    opus_es = "opensubtitles2018/OpenSubtitles.en-es.es1.txt"
    # opus_en = "opensubtitles2018/test1.txt"
    # opus_es = "opensubtitles2018/test2.txt"
